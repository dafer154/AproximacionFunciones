...
#include "../../AproximacionFunciones/interfaz.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Interfaz_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 36, 0)
    ...
    "Interfaz\0on_bt_abrirArchivo_clicked\0"
    ""
};
...
void Interfaz::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_bt_abrirArchivo_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Interfaz::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Interfaz.data,
      qt_meta_data_Interfaz,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Interfaz.stringdata))
        return static_cast<void*>(const_cast< Interfaz*>(this));
